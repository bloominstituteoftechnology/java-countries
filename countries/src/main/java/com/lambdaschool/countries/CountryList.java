...
public class CountryList
{
    ...
    //create for loop to sort through the information to find a country

    public Country findCountry(CheckCountry tester)// send it the lambda expressions
    {
        for (Country c: countryList)// search through the list
        {
            if (tester.test(c))// because this method is in here(in this class)
                // it already knows about ArrayList countryList we don't hav to do
        ...
        //lambda expression is going to implement test
    }
